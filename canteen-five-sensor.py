...
try:
    ...
    mySensorBaseAvg = (mySensor1.distance_cm() + mySensor2.distance_cm() + mySensor3.distance_cm() + mySensor4.distance_cm() + mySensor5.distance_cm()) / 5
    #mySensorBaseAvg = 600
    ...
    lcd.move_to(0,0)
    lcd.putstr("Base avg:" + int(str(mySensorBaseAvg))) 
    sleep_ms(2000)
    ...
    def main():
      ...
      while True:
        ...
        if (hitCount1 > 6 and hitCount2 > 6 and hitCount3 > 6 and hitCount4 > 6 and hitCount5 > 6 ):
            myQueueStatus = "A very long queue   "
            ...
            myQueueStatus = "A very short queue  "
        else:
